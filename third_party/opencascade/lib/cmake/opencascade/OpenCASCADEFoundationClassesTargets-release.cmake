...
set_target_properties(TKernel PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKernel.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKernel.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKernel )
list(APPEND _cmake_import_check_files_for_TKernel "${_IMPORT_PREFIX}/lib/libTKernel.7.9.3.dylib" )
...
set_target_properties(TKMath PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKMath.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKMath.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKMath )
list(APPEND _cmake_import_check_files_for_TKMath "${_IMPORT_PREFIX}/lib/libTKMath.7.9.3.dylib" )
