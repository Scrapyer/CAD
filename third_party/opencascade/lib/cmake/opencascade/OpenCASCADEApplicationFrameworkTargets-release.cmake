...
set_target_properties(TKCDF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKCDF.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKCDF.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKCDF )
list(APPEND _cmake_import_check_files_for_TKCDF "${_IMPORT_PREFIX}/lib/libTKCDF.7.9.3.dylib" )
...
set_target_properties(TKLCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKLCAF.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKLCAF.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKLCAF )
list(APPEND _cmake_import_check_files_for_TKLCAF "${_IMPORT_PREFIX}/lib/libTKLCAF.7.9.3.dylib" )
...
set_target_properties(TKCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKCAF.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKCAF.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKCAF )
list(APPEND _cmake_import_check_files_for_TKCAF "${_IMPORT_PREFIX}/lib/libTKCAF.7.9.3.dylib" )
...
set_target_properties(TKBinL PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBinL.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKBinL.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKBinL )
list(APPEND _cmake_import_check_files_for_TKBinL "${_IMPORT_PREFIX}/lib/libTKBinL.7.9.3.dylib" )
...
set_target_properties(TKXmlL PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXmlL.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKXmlL.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKXmlL )
list(APPEND _cmake_import_check_files_for_TKXmlL "${_IMPORT_PREFIX}/lib/libTKXmlL.7.9.3.dylib" )
...
set_target_properties(TKBin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBin.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKBin.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKBin )
list(APPEND _cmake_import_check_files_for_TKBin "${_IMPORT_PREFIX}/lib/libTKBin.7.9.3.dylib" )
...
set_target_properties(TKXml PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXml.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKXml.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKXml )
list(APPEND _cmake_import_check_files_for_TKXml "${_IMPORT_PREFIX}/lib/libTKXml.7.9.3.dylib" )
...
set_target_properties(TKStdL PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKStdL.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKStdL.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKStdL )
list(APPEND _cmake_import_check_files_for_TKStdL "${_IMPORT_PREFIX}/lib/libTKStdL.7.9.3.dylib" )
...
set_target_properties(TKStd PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKStd.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKStd.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKStd )
list(APPEND _cmake_import_check_files_for_TKStd "${_IMPORT_PREFIX}/lib/libTKStd.7.9.3.dylib" )
...
set_target_properties(TKTObj PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKTObj.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKTObj.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKTObj )
list(APPEND _cmake_import_check_files_for_TKTObj "${_IMPORT_PREFIX}/lib/libTKTObj.7.9.3.dylib" )
...
set_target_properties(TKBinTObj PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBinTObj.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKBinTObj.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKBinTObj )
list(APPEND _cmake_import_check_files_for_TKBinTObj "${_IMPORT_PREFIX}/lib/libTKBinTObj.7.9.3.dylib" )
...
set_target_properties(TKXmlTObj PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXmlTObj.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKXmlTObj.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKXmlTObj )
list(APPEND _cmake_import_check_files_for_TKXmlTObj "${_IMPORT_PREFIX}/lib/libTKXmlTObj.7.9.3.dylib" )
...
set_target_properties(TKVCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKVCAF.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKVCAF.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKVCAF )
list(APPEND _cmake_import_check_files_for_TKVCAF "${_IMPORT_PREFIX}/lib/libTKVCAF.7.9.3.dylib" )
