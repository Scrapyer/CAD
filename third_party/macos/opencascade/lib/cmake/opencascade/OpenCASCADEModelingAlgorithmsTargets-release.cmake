...
set_target_properties(TKGeomAlgo PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKGeomAlgo.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKGeomAlgo.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKGeomAlgo )
list(APPEND _cmake_import_check_files_for_TKGeomAlgo "${_IMPORT_PREFIX}/lib/libTKGeomAlgo.7.9.3.dylib" )
...
set_target_properties(TKTopAlgo PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKTopAlgo.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKTopAlgo.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKTopAlgo )
list(APPEND _cmake_import_check_files_for_TKTopAlgo "${_IMPORT_PREFIX}/lib/libTKTopAlgo.7.9.3.dylib" )
...
set_target_properties(TKPrim PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKPrim.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKPrim.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKPrim )
list(APPEND _cmake_import_check_files_for_TKPrim "${_IMPORT_PREFIX}/lib/libTKPrim.7.9.3.dylib" )
...
set_target_properties(TKBO PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBO.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKBO.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKBO )
list(APPEND _cmake_import_check_files_for_TKBO "${_IMPORT_PREFIX}/lib/libTKBO.7.9.3.dylib" )
...
set_target_properties(TKShHealing PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKShHealing.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKShHealing.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKShHealing )
list(APPEND _cmake_import_check_files_for_TKShHealing "${_IMPORT_PREFIX}/lib/libTKShHealing.7.9.3.dylib" )
...
set_target_properties(TKBool PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBool.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKBool.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKBool )
list(APPEND _cmake_import_check_files_for_TKBool "${_IMPORT_PREFIX}/lib/libTKBool.7.9.3.dylib" )
...
set_target_properties(TKHLR PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKHLR.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKHLR.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKHLR )
list(APPEND _cmake_import_check_files_for_TKHLR "${_IMPORT_PREFIX}/lib/libTKHLR.7.9.3.dylib" )
...
set_target_properties(TKFillet PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKFillet.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKFillet.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKFillet )
list(APPEND _cmake_import_check_files_for_TKFillet "${_IMPORT_PREFIX}/lib/libTKFillet.7.9.3.dylib" )
...
set_target_properties(TKOffset PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKOffset.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKOffset.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKOffset )
list(APPEND _cmake_import_check_files_for_TKOffset "${_IMPORT_PREFIX}/lib/libTKOffset.7.9.3.dylib" )
...
set_target_properties(TKFeat PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKFeat.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKFeat.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKFeat )
list(APPEND _cmake_import_check_files_for_TKFeat "${_IMPORT_PREFIX}/lib/libTKFeat.7.9.3.dylib" )
...
set_target_properties(TKMesh PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKMesh.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKMesh.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKMesh )
list(APPEND _cmake_import_check_files_for_TKMesh "${_IMPORT_PREFIX}/lib/libTKMesh.7.9.3.dylib" )
...
set_target_properties(TKXMesh PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXMesh.7.9.3.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libTKXMesh.7.9.dylib"
  )

list(APPEND _cmake_import_check_targets TKXMesh )
list(APPEND _cmake_import_check_files_for_TKXMesh "${_IMPORT_PREFIX}/lib/libTKXMesh.7.9.3.dylib" )
